...
## Overview
This directory contains all architectural decisions for the system.
...
- ADR-012: File-Based State Source of Truth
- ADR-013: Execution Service API Contract
- ADR-014: API-Driven State Management
- ADR-015: Adopt Drizzle ORM
- ADR-016: Versioned State Model
